        ...
        >
          <motion.div variants={fadeIn} className="max-w-3xl">
            ...
            <motion.p variants={fadeIn} className="text-xl md:text-2xl text-neutral-500 leading-relaxed mb-4">
              Hi, I'm Qossay Abuamriya. A Cloud & AI Software Engineer with <span className="text-neutral-800 font-medium">5 years</span> of experience, specializing in Agentic RAG, LLM fine-tuning, and highly available Kubernetes infrastructure.
            </motion.p>
            <motion.p variants={fadeIn} className="text-neutral-400 leading-relaxed mb-10 max-w-xl">
              I build production systems that combine AI, cloud-native architecture, and strong engineering practices—so teams can ship faster and scale with confidence.
            </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-neutral-500 leading-relaxed mb-6 max-w-lg text-lg">
                    Engineered a highly secure, context-aware AI support agent utilizing the Airia Platform, OpenAI, and Cohere. Implemented strict guardrails and Azure Content Filtering for responsible AI interaction. Delivers consistent, on-brand responses while reducing manual load on support teams.
                  </p>
                </div>
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-white/60 leading-relaxed mb-6">
                    Co-developed a cloud-native platform using Python and GenAI to solve domain challenges in insurance, law, and education. Fine-tuned LLMs on IBM WatsonX and Azure OpenAI for task-specific performance and lower latency.
                  </p>
            ...
            >
              ...
              <p className="text-neutral-500 mb-6 text-sm leading-relaxed">
                Designed workflows combining keyword and semantic search across SQL and unstructured data using LangChain, Azure AI Search, and AI Foundry—so users get the right context for AI answers.
              </p>
            ...
            >
              ...
              <p className="text-neutral-500 mb-6 text-sm leading-relaxed">
                Built a high-performance ID processing tool with Azure OCR and Document Intelligence. Handles mixed document formats automatically and feeds structured data into downstream workflows.
              </p>
              <div className="mt-auto pt-6 border-t border-neutral-100">
            ...
            >
              ...
              <p className="text-neutral-500 mb-6 text-sm leading-relaxed">
                Managed highly available Kubernetes (AKS/IKS) with NGINX load balancing. Delivered Terraform (IaC) and 20+ CI/CD pipelines for repeatable, auditable deployments.
              </p>
